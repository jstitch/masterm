...
perspective, so the interface of the program was originally written in that
language. One of the TODOs in my list is to write a good localization support
for it, so that this won't be a problem any more. The purpose of version 1.1.1
is to implement that localization support. But even though this fact, I
